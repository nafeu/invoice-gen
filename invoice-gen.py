...
parser.add_argument('customer_id', nargs='?', const=0, help="enter customer id to initiatlize invoice")
parser.add_argument("-l", "--list-customers", help="list all customers", action='store_true')
